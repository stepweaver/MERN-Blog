...
import { createPlan } from '../../APIServices/plans/plansAPI';
...
const CreatePlan = () => {
  ...
  console.log("🚀 ~ onSubmit: ~ planMutation:", planMutation)
    ...
    <div className='flex flex-col items-center justify-center min-h-screen bg-gray-100'>
      ...
      >
        ...
        {planMutation.isError && (
          <AlertMessage type='error' message={planMutation?.error?.response?.data?.message} />
        )}
